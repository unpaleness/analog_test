...
public:
    ...
    double maximumOutputValue() const      { return m_maxOutputVal; }
    void setMaximumOutputValue(double val) { m_maxOutputVal = val; }
...
protected:
    ...
    void contexMenuPrefix(QMouseEvent *event); // inherited from AbstractMeter

private:
    double m_maxOutputVal;
};
#endif // BARMETER_H
